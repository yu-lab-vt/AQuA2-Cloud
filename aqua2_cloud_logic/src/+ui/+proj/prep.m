function prep()
    ...
    if loadingProject==0
        ...
        [datOrg1,datOrg2,opts] = burst.prep1(filepath1,[name1,ext1],filepath2,[name2,ext2],[],opts);
        ...
        % UI data structure
        [ov,bd,scl,btSt] = ui.proj.prepInitUIStruct(datOrg1,opts);
    ...
    if loadingProject>0
        ...
        Supervisor.instanceBusySQL(true, 'Loading');
    ...
    % UI
    ui.proj.prepInitUI(f,fh,opts,scl,ov,stg,loadingProject);
    projectState = 2;
end
