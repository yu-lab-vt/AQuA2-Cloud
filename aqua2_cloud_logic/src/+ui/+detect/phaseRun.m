...
disp('Detecting channel 1');
Supervisor.instanceBusySQL(true, 'Detecting channel 1');
if(fh.needTemp.Value)
    ...
    if(~opts.singleChannel)
        ...
        disp('Detecting channel 2');
        Supervisor.instanceBusySQL(true, 'Detecting channel 2');
...
disp('Step 2aa: seeds')
Supervisor.instanceBusySQL(true, 'Step 2aa: seeds');

ui.detect.postRun([],[],f,sdLst1,sdLst2,[],[],'Step 3aa: seeds');

disp('Step 2ab')
Supervisor.instanceBusySQL(true, 'Step 2ab: watershed results');

ui.detect.postRun([],[],f,subEvtLst1,subEvtLst2,[],[],'Step 3a: watershed results');

disp('Step 2b: super events')
Supervisor.instanceBusySQL(true, 'Step 2b: super events');
