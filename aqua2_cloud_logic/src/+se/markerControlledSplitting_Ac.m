function [evtLst,sdLst,curRegions] = markerControlledSplitting_Ac(Map,curRegions,dF,opts)
% ----------- Modified by Xuelong Mi, 02/20/2023 -----------
    ...
    for t = 1:T
        scoreMap(:,:,:,t) = -imgaussfilt3(dF(:,:,:,t),opts.spaSmo);% spatial smoothing for weakening gap in spatial
    end
    clear dF;
    clear dFOrg;
    % calculate scoreMap
