function [dF,opts] = baselineRemoveAndNoiseEstimation(datOrg,opts,evtSpatialMask,ch)
...
% ----------- Modified by Xuelong Mi, 03/22/2023 -----------
    ...
    disp('Noise estimation function ');
    Supervisor.instanceBusySQL(true, 'Noise estimation function');
