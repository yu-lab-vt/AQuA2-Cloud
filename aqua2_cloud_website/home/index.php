...
.<br>
                ...
                <div class="media text-muted pt-3">
                    <img data-src="holder.js/32x32?theme=thumb&bg=007bff&fg=007bff&size=1" alt="" class="mr-2 rounded">
                    <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                        <strong class="d-block text-gray-dark">[AQuA2-Cloud | Activity Quantification and Analysis 2 Online]</strong>
			This application allows for intensity-based activity detection within a broad range of fluorescence imaging movies<br>
			Supported browsers: Edge, Firefox, & Chrome<br>
						<font color="green">
						Version: 1.0.0
